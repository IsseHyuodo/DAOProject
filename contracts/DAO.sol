...
// all the raised prop are stored in the mapping
...
// contains all the voting info about a particular prop
// referenced by prop id

mapping(uint256=>VotedStruct[]) private votedOn;


// total contrbution for each contributor
mapping(address=>uint256) private contributors;

// total contributions for each stakeholders;
